...
if((isset($_SESSION['loggedInUser'])) && ($_SESSION['loggedInUser'] == true)) {
  header('Location: indexForLoggedIn.php');
  exit();
}
    ...
    <ul>
      ...
      include 'php/data.php';
        for ($i = 0; $i < count($navigation_elements); $i++) {
          if ($navigation_elements[$i] == "Zarządzaj postami" || $navigation_elements[$i] == "Dodaj Post" || $navigation_elements[$i] == "Panel administracyjny") {
            continue;
          }
